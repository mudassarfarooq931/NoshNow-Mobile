              ...
              <ScrollView style={styles.modalScrollView}>
                <View style={styles.adminDetailCard}>
                  <View style={styles.adminDetailHeader}>
                    <View style={styles.adminDetailAvatar}>
                      <User size={32} color={colors.primary} />
                    </View>
                    <View style={styles.adminDetailInfo}>
                      <Text style={styles.adminDetailName}>
                        {selectedAdmin.name}
                      </Text>
                      <Text style={styles.adminDetailEmail}>
                        {selectedAdmin.email}
                      </Text>
                      <View style={styles.adminDetailRole}>
                        <Shield size={14} color={colors.primary} />
                        <Text style={styles.adminDetailRoleText}>
                          Administrator
                        </Text>
                      </View>
                    </View>
                  ...
                  <View style={styles.adminDetailSection}>
                    <Text style={styles.adminDetailSectionTitle}>
                      Contact Information
                    </Text>
                    ...
                    <View style={styles.adminDetailRow}>
                      ...
                      <Text style={styles.adminDetailValue}>
                        {selectedAdmin.address || 'Not provided'}
                      </Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.adminDetailSection}>
                    ...
                    <View style={styles.adminDetailRow}>
                      <Store size={20} color={colors.green} />
                      <Text style={styles.adminDetailLabel}>Restaurant:</Text>
                      <Text style={styles.adminDetailValue}>
                        {getAssignedRestaurant(selectedAdmin.id)}
                      </Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.adminDetailSection}>
                    ...
                    <View style={styles.adminDetailStats}>
                      <View style={styles.adminDetailStatItem}>
                        <Text style={styles.adminDetailStatValue}>
                          {getAdminStats(selectedAdmin.id).totalOrders}
                        </Text>
                        <Text style={styles.adminDetailStatLabel}>
                          Total Orders
                        </Text>
                      </View>
                      <View style={styles.adminDetailStatItem}>
                        <Text style={styles.adminDetailStatValue}>
                          {getAdminStats(selectedAdmin.id).revenue}
                        </Text>
                        <Text style={styles.adminDetailStatLabel}>Revenue</Text>
                      </View>
                    </View>
                  </View>
                </View>
...
const styles = StyleSheet.create({
  ...
  adminDetailStatValue: {
    fontSize: 18,
    fontWeight: 'bold',
    color: colors.primary,
    marginBottom: 4,
  },
  adminDetailStatLabel: {
    fontSize: 12,
    color: colors.gray,
  },
});
